...
public class PostgresTransactionRepository implements TransactionRepository {
    ...
    public static class Queries {
        ...
        public static final String INSERT_TRANSACTION = "INSERT INTO transactions(id, user_id, wallet_id, " +
                "transaction_amount, transaction_type, asset_symbol, created_at) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        public static final String GET_ALL_TRANSACTIONS_FOR_USER = "SELECT t.id AS transaction_id, user_id, wallet_id, transaction_type, " +
